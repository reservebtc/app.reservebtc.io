...
// Minimal interface for unwrap, renamed to avoid clashing with your existing IRBTCSynth.
interface IRBTCSynthUnwrap {
...
contract VaultWrBTC is ReentrancyGuard {
    ...
    function redeem(uint256 amount) external nonReentrant {
        ...
        IRBTCSynthUnwrap(rbtc).unwrapFromVault(msg.sender, amount);
