    ...
    try {
      ...
      if (oracleData.transactionHashes && Array.isArray(oracleData.transactionHashes)) {
        ...
        oracleData.transactionHashes.forEach((tx: any, index: number) => {
          ...
          transactions.push({
            ...
            tokenAddress: tx.tokenAddress || '0x5b9375b4ac0f61C7D5af32374aCCe0d058cE6F58',
      ...
      if (oracleData.lastTxHash && !transactions.some(tx => tx.hash === oracleData.lastTxHash)) {
        ...
        transactions.push({
          ...
          tokenAddress: '0x5b9375b4ac0f61C7D5af32374aCCe0d058cE6F58',
          gasUsed: 0,
          gasPrice: '0',
          fee: '0',
      ...
      const universalProfile: any = {
        ...
        userStatistics: {
          ...
          mostActiveContract: '0x5b9375b4ac0f61C7D5af32374aCCe0d058cE6F58',
